        ...
        <div className="info-sec__cards">
          ...
          <div className="info-card">
            ...
            <div className="info-card__body">
              ...
              <p className="info-card__text">Ordina anche tramite WhatsApp o chiamaci direttamente.</p>
              <div className="info-card__contacts">
                <a href="https://wa.me/393200000000" target="_blank" rel="noopener noreferrer" className="info-card__contact-btn info-card__contact-btn--wa">
